...
Agent skill: [`skills/ts-pf-codegen/`](skills/ts-pf-codegen/). Sync with `npx skills experimental_sync -y`. Runnable split-repo app: [`examples/codegen`](../../examples/codegen).
